...
python scripts/run_reid_pipeline.py \
...
python scripts/match_multicamera.py \
...
python scripts/produce_retrieval_embeddings.py \
...
python scripts/build_cctv_database.py \
